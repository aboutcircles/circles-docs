...
Circles is a decentralized protocol offering social and economic value to humans, communities, and groups. Circles is not a crypto startup or product in general, but a collective effort to bring a fair distribution model for the money created, owned and shared by people.
